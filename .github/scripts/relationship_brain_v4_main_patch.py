...
# Service: remember exact draft and use recent authorized imported messages.
...
# Radar universal WhatsApp handoff.
replace_once(radar,
"import { LanguageCode } from '../../types';",
"import { LanguageCode } from '../../types';\nimport { openWhatsAppDraft } from '../../core/client/whatsappDelivery';",
'radar helper import')
replace_once(radar, "noPhone: 'Adicione o telefone para abrir o WhatsApp.'", "noPhone: 'Sem número salvo: escolha o contato no WhatsApp.'", 'radar pt')
replace_once(radar, "noPhone: 'Add a phone number to open WhatsApp.'", "noPhone: 'No saved number: choose the contact in WhatsApp.'", 'radar en')
replace_once(radar, "noPhone: 'Agrega el teléfono para abrir WhatsApp.'", "noPhone: 'Sin número guardado: elige el contacto en WhatsApp.'", 'radar es')
replace_once(radar,
...
'radar universal whatsapp')

# Source outreach universal WhatsApp.
replace_once(sources,
"import { Person360Panel } from '../contacts/Person360Panel';",
"import { Person360Panel } from '../contacts/Person360Panel';\nimport { openWhatsAppDraft } from '../../core/client/whatsappDelivery';",
'sources helper import')
replace_once(sources,
