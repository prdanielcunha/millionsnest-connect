...
export const menuUxCatalog: Record<LanguageCode, MenuUxStrings> = {
  'pt-BR': {
    ...
    protectedOptionsHeader: '🎵 Opções Autenticadas (MusicScale)',
    ...
    reasonUnlinked: 'Bloqueado: Requer cenário de Membro Vinculado.',
  ...
  'en-US': {
    ...
    protectedOptionsHeader: '🎵 Authenticated Options (MusicScale)',
    ...
    reasonUnlinked: 'Blocked: Requires Linked Member scenario.',
  ...
  'es-ES': {
    ...
    protectedOptionsHeader: '🎵 Opciones Autenticadas (MusicScale)',
    ...
    reasonUnlinked: 'Bloqueado: Requiere el escenario de Miembro Vinculado.',
