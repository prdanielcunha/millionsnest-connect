...
export const Shell: React.FC<ShellProps> = ({
  ...
  const liveNavItems = [
    ...
    { id: 'opportunities', icon: Users, section: 'relationship' as LiveNavSection, status: 'ready' as LiveNavStatus },
    { id: 'playbooks', icon: BookOpen, section: 'relationship' as LiveNavSection, status: 'ready' as LiveNavStatus },
    { id: 'composer', icon: SparklesIcon, section: 'relationship' as LiveNavSection, status: 'ready' as LiveNavStatus },
    { id: 'intelligence', icon: BrainCircuit, section: 'relationship' as LiveNavSection, status: 'ready' as LiveNavStatus },
    { id: 'automations', icon: Workflow, section: 'operations' as LiveNavSection, status: 'controlled' as LiveNavStatus },
